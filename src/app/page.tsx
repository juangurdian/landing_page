        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-md mx-auto text-base text-gray-600 sm:text-lg md:mt-8 md:text-xl md:max-w-3xl">
              Celebra a Papá con nosotros y participa en un sorteo especial para el Día del Padre. ¡Gana increíbles premios!
            </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-gray-900 font-medium">Sorteo Especial</p>
                    <p className="text-gray-600">Solo hay un sorteo para el Día del Padre al final del mes.</p>
                  </div>
                </div>
              </div>
            </div>
